...
?>
<article id="forum-card-<?php echo esc_attr( (string) get_the_ID() ); ?>" class="card forum-card" data-reveal>
	<?php if ( $image ) : ?>
	...
	<div class="card-body">
		...
		<div class="forum-byline">
			...
			<?php CYWater_Forum_Community::render_like_control( get_the_ID(), 'card' ); ?>
		</div>
	</div>
