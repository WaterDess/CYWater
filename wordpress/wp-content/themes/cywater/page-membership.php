	...
	<section class="section">
		<div class="container">
			...
			<div class="benefits-grid grid-3">
				...
				<div class="feature" data-reveal><div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><path d="M4 5h16v11H9l-5 4Z"/><path d="M8 9h8M8 12h5"/></svg></div><h3 style="font-size:var(--fs-md)">Member Forum</h3><p>Verified active members can submit Forum articles for moderator review and join discussions.</p></div>
