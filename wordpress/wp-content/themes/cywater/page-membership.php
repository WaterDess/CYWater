...
while ( have_posts() ) :
	...
	$checkout_urls    = array();
	foreach ( array( 'student', 'professional', 'lifetime' ) as $level_key ) {
	...
	<section class="section-tight">
		<div class="container container-narrow">
			<div class="prototype-notice" data-reveal>
				...
				<div><strong>Membership registration is available for staging tests.</strong><span id="membership-preview-note" style="display:block; margin-top:.2rem">Choose an individual membership type, sign in or create your CYWater account, then complete your profile and secure payment.</span></div>
			</div>
		</div>
	</section>
