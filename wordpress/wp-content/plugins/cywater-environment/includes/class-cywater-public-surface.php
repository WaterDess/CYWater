...
final class CYWater_Public_Surface {
	 ...
	 * specific account. Nothing is opened wholesale: an account that has
	 * published nothing still 404s, so numeric enumeration stays closed. The
	 * forum uses this to make "browse by author" work; without the filter its
	 * opt-in is dead code and every author archive 404s.
	 */
