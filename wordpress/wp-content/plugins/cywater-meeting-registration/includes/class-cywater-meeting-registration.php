...
final class CYWater_Meeting_Registration {
	...
	private static function annual_meeting_2026_content() {
		return <<<'HTML'
<!-- wp:paragraph -->
<p>Against the backdrop of global climate change, the risks of extreme rainfall and flooding, drought and water scarcity, and compound extreme events are rising markedly. Accurate early warning and smart prevention and control of extreme water disasters have become urgent priorities for water security and disaster-risk reduction. In response, the 14th Annual Conference of the International Association of Contemporary Young Scholars in Water Sciences (CYWater) will be held together with the High-Level Forum on “Smart Prevention and Control of Extreme Water Disasters Driven by the Meteorology–Hydrology Nexus,” bringing together young water scientists from China and around the world for collaborative exchange.</p>
<!-- /wp:paragraph -->
<!-- wp:heading --><h2>Conference theme</h2><!-- /wp:heading -->
<!-- wp:paragraph --><p>Under the theme “Smart Prevention and Control of Extreme Water Disasters Driven by the Meteorology–Hydrology Nexus,” the conference will bring together experts and emerging researchers at the forefront of hydrosphere science to discuss water-cycle evolution under a changing environment, early-warning mechanisms for compound extreme-disaster chains, and the latest applications of hydrological remote sensing, digital-twin water networks, and physics-constrained intelligent large models.</p><!-- /wp:paragraph -->
<!-- wp:heading --><h2>Conference organization</h2><!-- /wp:heading -->
<!-- wp:paragraph --><p><strong>Organizer:</strong> International Association of Contemporary Young Scholars in Water Sciences (CYWater).</p><!-- /wp:paragraph -->
<!-- wp:paragraph --><p><strong>Hosted by:</strong> Nanjing University of Information Science and Technology (NUIST); Key Laboratory of Hydrometeorological Disaster Mechanism and Warning of the Ministry of Water Resources; and State Key Laboratory of Climate System Prediction and Risk Management.</p><!-- /wp:paragraph -->
<!-- wp:heading --><h2>Conference date and venue</h2><!-- /wp:heading -->
<!-- wp:list --><ul><li><strong>October 16, 2026:</strong> participant check-in</li><li><strong>October 17–18, 2026:</strong> academic sessions</li><li><strong>October 19, 2026:</strong> departure</li><li><strong>Venue:</strong> Nanjing University of Information Science and Technology, No. 219 Ningliu Road, Nanjing, Jiangsu, China</li></ul><!-- /wp:list -->
<!-- wp:heading --><h2>Conference programme and sessions</h2><!-- /wp:heading -->
<!-- wp:paragraph --><p>The programme will include six keynote presentations, 28 featured presentations (seven in each of four thematic sessions), 20 youth flash talks, and approximately 40–50 posters displayed throughout the conference.</p><!-- /wp:paragraph -->
<!-- wp:table {"className":"cywater-meeting-table cywater-meeting-sessions"} --><figure class="wp-block-table cywater-meeting-table cywater-meeting-sessions"><table><thead><tr><th>Session</th><th>Theme</th><th>Conveners</th></tr></thead><tbody><tr><td>Session 1</td><td>Water Cycle and Extreme Hydrometeorological Forecasting under a Changing Environment</td><td>Shanshui Yuan, Yiwen Mei, Chiyuan Miao, Gang Zhao, Peng Ji</td></tr><tr><td>Session 2</td><td>Ecohydrological Processes and Coordinated Allocation of Water Resources</td><td>Lei Cheng, Zhenzhong Zeng, Weili Duan, Baoqing Zhang, Hongyan Wang</td></tr><tr><td>Session 3</td><td>Watershed Water–Sediment Evolution, Safe and Resilient Water Networks, and Engineering Control</td><td>Li Chen, Dong Chen, Saiyu Yuan, Jingming Hou, Yuhan Yang</td></tr><tr><td>Session 4</td><td>Remote Sensing–Physics–Intelligence Modeling and Digital Twin Water Networks</td><td>Shulei Zhang, Xudong Zhou, Jie Wang, Feng Ma</td></tr><tr><td>Youth forum</td><td>Forum on Interdisciplinary Frontiers and Outstanding Young Talent for Young Scholars<span class="cywater-meeting-parenthetical">(flash talks)</span></td><td>Guoqiang Tang, Menghao Wang, Yangchen Lai</td></tr></tbody></table></figure><!-- /wp:table -->
<!-- wp:heading --><h2>Presentation and poster submission</h2><!-- /wp:heading -->
<!-- wp:paragraph --><p>Experts and scholars, faculty and students, and representatives of research institutions, companies, and public organizations working in hydrology and water resources, meteorological science, environmental ecology, hydraulic engineering, artificial intelligence, and related fields are warmly invited to contribute and participate.</p><!-- /wp:paragraph -->
<!-- wp:paragraph --><p>Use the registration form on this page to indicate an oral presentation, youth flash talk, poster, or attendance without a presentation; enter the proposed title and abstract where applicable; and upload a presentation or poster file if ready. The submission deadline for conference presentations and posters is <strong>September 28, 2026</strong>. The organizing committee will confirm programme placement separately.</p><!-- /wp:paragraph -->
<!-- wp:heading {"level":3} --><h3>Outstanding Presentation Award</h3><!-- /wp:heading -->
<!-- wp:paragraph --><p>To encourage young scholars to deliver outstanding academic presentations, the conference will present the <strong>CYWater Young Scientist Outstanding Presentation Award</strong>, sponsored by <em>npj Hydrosphere</em> and evaluated and awarded in cooperation with CYWater.</p><!-- /wp:paragraph -->
<!-- wp:heading --><h2>Registration fees</h2><!-- /wp:heading -->
<!-- wp:paragraph --><p>Registration fees are offered by membership status and participant category. The early-bird deadline is <strong>September 20, 2026</strong>; standard rates apply after that date and to on-site registration.</p><!-- /wp:paragraph -->
<!-- wp:table {"className":"cywater-meeting-table cywater-meeting-fees"} --><figure class="wp-block-table cywater-meeting-table cywater-meeting-fees"><table><thead><tr><th>Category</th><th>Early bird through Sep 20</th><th>Standard / on site</th></tr></thead><tbody><tr><td>Regular member<span class="cywater-meeting-parenthetical">(faculty or scholar)</span></td><td>CNY 1,000<span class="cywater-meeting-parenthetical">(~USD 150)</span></td><td>CNY 1,200<span class="cywater-meeting-parenthetical">(~USD 180)</span></td></tr><tr><td>Regular non-member</td><td>CNY 1,600<span class="cywater-meeting-parenthetical">(~USD 240)</span></td><td>CNY 1,800<span class="cywater-meeting-parenthetical">(~USD 270)</span></td></tr><tr><td>Student member</td><td>CNY 500<span class="cywater-meeting-parenthetical">(~USD 75)</span></td><td>CNY 700<span class="cywater-meeting-parenthetical">(~USD 105)</span></td></tr><tr><td>Student non-member</td><td>CNY 800<span class="cywater-meeting-parenthetical">(~USD 120)</span></td><td>CNY 1,000<span class="cywater-meeting-parenthetical">(~USD 150)</span></td></tr><tr><td>Corporate representative</td><td>CNY 2,200<span class="cywater-meeting-parenthetical">(~USD 330)</span></td><td>CNY 2,600<span class="cywater-meeting-parenthetical">(~USD 390)</span></td></tr></tbody></table></figure><!-- /wp:table -->
<!-- wp:list --><ul><li>Students must upload a valid student ID card or current certificate of enrollment when registering.</li><li>Member rates are based on the active CYWater membership attached to the signed-in account.</li><li>Invited speakers receive a registration-fee waiver, subject to organizer verification; travel and accommodation remain at their own expense.</li><li>The fee includes conference materials, coffee breaks, and lunch during the conference; accommodation is not included.</li></ul><!-- /wp:list -->
<!-- wp:heading --><h2>Payment, member discount, and invoice</h2><!-- /wp:heading -->
<!-- wp:paragraph --><p>CYWater membership is optional. Participants who want the member rate should complete membership registration and payment before submitting the meeting form. After you sign in, this page reads the active membership attached to your account and recommends the applicable external meeting fee.</p><!-- /wp:paragraph -->
<!-- wp:paragraph --><p>Submit the registration form before paying. The organizer-designated Alipay QR code and your recommended amount appear in the confirmation area after a successful submission. Payment is completed outside the CYWater website. Add your full name to the payment note and verify the displayed recipient before paying. The applicable fee will be checked at on-site registration, and Nanjing University of Information Science and Technology will issue the invoice after the conference.</p><!-- /wp:paragraph -->
<!-- wp:heading --><h2>Accommodation</h2><!-- /wp:heading -->
<!-- wp:paragraph --><p>Accommodation may be reserved at Longshan Lake Hotel, approximately 2 km from the university. Shuttle buses will be arranged between the hotel and the conference venue. The organizer’s reference rate is CNY 380 per night for a standard room, including breakfast.</p><!-- /wp:paragraph -->
<!-- wp:list --><ul><li><strong>Address:</strong> Longshan Lake Hotel, No. 7 Yaogu Avenue, Jiangbei New Area, Nanjing</li><li><strong>Hotel contact:</strong> Mr. Yao, +86 25 5886 0888</li><li><strong>Reservation:</strong> use the separate hotel WeChat mini-program QR code shown after registration</li></ul><!-- /wp:list -->
<!-- wp:paragraph --><p>Accommodation is reserved and paid directly with the hotel and is not booked or paid through CYWater.</p><!-- /wp:paragraph -->
<!-- wp:heading --><h2>Contact and follow-up notices</h2><!-- /wp:heading -->
...
<!-- wp:paragraph --><p>Detailed programme information, presentation instructions, and subsequent updates will be published in the Second Announcement and on this official meeting page. For matters not covered above, refer to the Second Announcement when released.</p><!-- /wp:paragraph -->
HTML;
	}
	...
	public static function cli_qa() {
		...
		try {
			...
			$source_content = self::annual_meeting_2026_content();
			$assert( str_contains( $source_content, 'October 16, 2026' ) && str_contains( $source_content, 'September 20, 2026' ), 'Source dates incomplete.' );
			$assert( str_contains( $source_content, 'Conference programme and sessions' ) && str_contains( $source_content, 'Water Cycle and Extreme Hydrometeorological Forecasting' ) && str_contains( $source_content, 'Guoqiang Tang, Menghao Wang, Yangchen Lai' ), 'Conference-session source content incomplete.' );
			$assert( 12 === substr_count( $source_content, 'class="cywater-meeting-parenthetical"' ), 'Parenthetical table details must render on their own line.' );
			$assert( str_contains( $source_content, 'Participants who want the member rate' ) && str_contains( $source_content, 'issue the invoice after the conference' ), 'Registration and invoice guidance incomplete.' );
			$assert( str_contains( $source_content, 'approximately 2 km from the university' ) && str_contains( $source_content, 'Website registration support: contact@cywater.org' ), 'Accommodation or contact source content incomplete.' );
