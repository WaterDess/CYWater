...
| `plugins/cywater-forum` | Forum articles and taxonomies, verified active-member submission gates, moderator-only publication, Forum-specific comment and moderation boundaries | Membership state, PMPro orders, unrelated WordPress comments, broad site administration |
