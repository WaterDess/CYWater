...
- On 2026-08-29 CYWater Meeting Registration `0.1.15` was deployed to staging
  ...
  within the viewport. Parenthetical table details always start on their own
  second line. Staging passed 34 self-cleaning meeting assertions.
...
- Staging Logo Call QA passed 38 self-cleaning checks and Operations passed 438;
  ...
  The reward-term follow-up database and prior Logo/Operations trees are at
