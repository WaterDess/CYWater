...
$content = '<p>CYWater invites registered users to submit one original association logo. After submissions close, a separate voting phase ranks eligible designs; the three highest-ranked designs become finalists, and the Board selects the official logo from those three finalists. This Event hosts the removable submission and voting module below.</p>';
$data    = array(
	'post_type'    => 'cyw_event',
	'post_status'  => 'publish',
	'post_name'    => $slug,
...
$settings = array(
	...
	'_cyw_end_date'                      => '2026-09-21',
	'_cyw_date_label'                    => 'Aug 12–Sep 21, 2026',
