...
try {
	...
	$assert( defined( 'CYWATER_MEMBERSHIP_VERSION' ) && '0.9.9' === CYWATER_MEMBERSHIP_VERSION, 'CYWater Membership version is 0.9.9' );
	$assert( '0.6.53' === wp_get_theme()->get( 'Version' ), 'CYWater theme version is 0.6.53' );
