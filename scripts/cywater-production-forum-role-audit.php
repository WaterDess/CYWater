...
$audit_assert( '0.6.2' === (string) ( $plugin_data['Version'] ?? '' ), 'Unexpected CYWater Forum production version.' );
$audit_assert( '0.6.48' === (string) $theme->get( 'Version' ), 'Unexpected CYWater theme production version.' );
