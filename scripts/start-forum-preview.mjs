 ...
 *
 *   - an endorsed author who can publish immediately
 *   - an unendorsed candidate who sees the "become an author" path
 *
...
update_user_meta( $candidate, 'preview_active_membership', 1 );
...
────────────────────────────────────────────────────────────────────────
  ...
  Candidate — not endorsed, sees the "become an author" path
  ...
  To watch the endorsement flow: sign in as forum.candidate, open
