...
assert(themeHeader.includes("Version: 0.6.61"), "CYWater theme header version is not current.");
assert(themeFunctions.includes("CYWATER_THEME_VERSION', '0.6.61"), "CYWater theme runtime version is not current.");
