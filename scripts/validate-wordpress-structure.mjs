...
assertMarkers(
  ...
  [
    ...
    "Finalist reward: the five highest-ranked eligible designs receive two years of Professional membership",
    ...
    "five highest-ranked eligible designs become finalists",
    "member-program",
