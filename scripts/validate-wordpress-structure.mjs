...
assert(themeHeader.includes("Version: 0.6.58"), "CYWater theme header version is not current.");
assert(themeFunctions.includes("CYWATER_THEME_VERSION', '0.6.58"), "CYWater theme runtime version is not current.");
...
assertMarkers(
  ...
  [
    ...
    "Participation reward: Student membership through December 31, 2026",
    "Finalist reward: eligible designs confirmed as finalists after voting receive one year of Professional membership",
    "Two years of CYWater Professional membership",
    "winning-design rights assignment",
    "data-cywater-logo-countdown",
    "cywater_logo_legal_name",
    "After submissions close, a separate voting activity will be held",
    "Closed submissions wait safely for an unscheduled voting activity",
    "Governance confirms the finalist group from the highest-ranked eligible designs",
    "member-program",
